...
import { GET_USERS_QUERY, CHECK_EXISTING_CONVERSATION_QUERY } from "./queries";
...
const ConversationDialog = (props) => {
    ...
    return (
        ...
        >
            ...
            <DialogContent>
                <DialogContentText>
                    To start a new conversation, add who you want to chat with
                    in the Participant list, give your conversation a title and
                    start chatting!
                </DialogContentText>
                <TextField
                    fullWidth
